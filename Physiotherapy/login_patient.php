...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="login_patient.css" />
  <title>Log In</title>
</head>
...
<body>
  ...
  <section class="content">
    <div class="container-fluid">
      <div class="container">
        <form name="patient_login" class="form-horizontal" role="form" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
          <h3>Log In</h3>
          <br />
          <div class="form-group <?php echo (!empty($national_id_err)) ? 'has-error' : ''; ?>">
            ...
            <br>
            <br>
            <button type="submit" class="btn btn-primary" value="sumbit">Log In</button>
            <a href="signup_patient.php">Not registered?</a>
          </div>
        </form>
      </div>
    </div>
